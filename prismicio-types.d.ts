...
/**
 * Primary content in *TextAndImage → ImageOnLeft → Primary*
 */
export interface TextAndImageSliceImageOnLeftPrimary {
  /**
   * Theme field in *TextAndImage → ImageOnLeft → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
  ...
  /**
   * Heading field in *TextAndImage → ImageOnLeft → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *TextAndImage → ImageOnLeft → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Button field in *TextAndImage → ImageOnLeft → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
  ...
  /**
   * Background Image field in *TextAndImage → ImageOnLeft → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
  ...
  /**
   * Foreground Image field in *TextAndImage → ImageOnLeft → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
...
/**
 * ImageOnLeft variation for TextAndImage Slice
 *
 * - **API ID**: `imageOnLeft`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
