...
/**
 * HorizontalLine component renders an SVG horizontal line.
 *
 * @param {SVGProps<SVGSVGElement>} props - The props for the SVG element.
 * @returns {JSX.Element} The JSX code to render the horizontal line.
 */
...
/**
 * VerticalLine component renders an SVG vertical line.
 *
 * @param {SVGProps<SVGSVGElement>} props - The props for the SVG element.
 * @returns {JSX.Element} The JSX code to render the vertical line.
 */
